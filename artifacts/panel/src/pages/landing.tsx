...
import { ArrowRight, BookOpen, Building2, Users, CheckCircle2, Upload } from "lucide-react";
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button size="lg" className="h-14 px-8 text-lg" asChild>
                  <Link href="/dashboard">
                    Entrar al panel de gestión <ArrowRight className="ml-2 h-5 w-5" />
                  </Link>
                </Button>
          ...
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="bg-background border border-border rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow">
